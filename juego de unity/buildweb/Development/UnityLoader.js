...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'buildweb.data';
    var REMOTE_PACKAGE_BASE = 'buildweb.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4273261;
      var PACKAGE_UUID = 'e51eee32-4821-4305-91fd-c03ad5bd77b4';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 1462351, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(1462351, 1462649, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(1462649, 1465916, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(1465916, 3370664, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3370664, 4245636, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4245636, 4273261, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_buildweb.data');

    };
    Module['addRunDependency']('datafile_buildweb.data');
